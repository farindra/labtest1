                ...
                <div class="user-info">
                    ...
                    <div class="user-image">
                        <a href="extra-profile.html">
                            <img src="<?= SSS_IMAGE_PATH ?>user-2.png" class="img-responsive img-circle" />
                        </a>
                    </div>
...
<div class="navbar-brand">
    <a href="dashboard-1.php" class="logo">
        <img src="<?= SSS_IMAGE_PATH ?>logo-white-bg@2x.png" width="80" alt="" class="hidden-xs" />
        <img src="<?= SSS_IMAGE_PATH ?>logo@2x.png" width="80" alt="" class="visible-xs" />
    </a>
    <a href="#" data-toggle="settings-pane" data-animate="true">
...
<li class="dropdown user-profile">
    <a href="#" data-toggle="dropdown">
        <img src="<?= SSS_IMAGE_PATH ?>user-1.png" alt="user-image" class="img-circle img-inline userpic-32" width="28" />
						<span>
							Arlind Nushi
