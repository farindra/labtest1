...
-- Records of employe
-- ----------------------------
INSERT INTO `employe` VALUES ('EMP001', 'Piter Novian', 'piter.png', 'Piter.jpg');
INSERT INTO `employe` VALUES ('EMP002', 'Farindra Eka Putra', 'eka.png', 'Eka.jpg');
INSERT INTO `employe` VALUES ('EMP003', 'Stephen', 'Stephen.jpg', 'Stephen.jpg');
INSERT INTO `employe` VALUES ('EMP004', 'Alam Mahfian', 'alam.jpg', 'Alam.jpg');
INSERT INTO `employe` VALUES ('EMP006', 'Ailey', null, 'Ailey.jpg');
INSERT INTO `employe` VALUES ('EMP007', 'Erick', null, 'Erick.jpg');

-- ----------------------------
-- Table structure for `employe_data`
-- ----------------------------
DROP TABLE IF EXISTS `employe_data`;
CREATE TABLE `employe_data` (
  `EMP_ID` varchar(10) NOT NULL,
  `EMP_ALAMAT` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`EMP_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of employe_data
-- ----------------------------
INSERT INTO `employe_data` VALUES ('EMP001', 'DUTA BINTARO');
